...
export async function generateMetadata({
  ...
  // Skip course lookup for reserved routes
  ...
  if (reservedRoutes.includes(slug)) {
    return {
      title: "Forged",
      description: "Transform your PDFs into beautiful, sellable pages",
    };
  }
  ...
  try {
    ...
    const description =
      dbCourse.description || "Discover premium educational content on Forged";
    const imageUrl =
      dbCourse.imageUrl ||
    ...
    const getDefaultKeywords = () => {
      if (isCourse)
        return "course, online learning, education, lessons, training, skill development";
