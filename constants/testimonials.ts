export const testimonials = [
  {
    ...
    content:
      "Forged transformed my scattered notes into a professional marketing course! Can't wait to see how it goes!",
    rating: 5,
    previewData: {
  ...
  - Keyword research strategies`,
      ...
      price: 89,
      description:
        "Master digital marketing with proven strategies and real-world examples",
    },
  },
  {
    id: 2,
    ...
    content:
      "Incredible platform! My coding notes became a structured programming course. The AI understood my technical concepts perfectly.",
    rating: 5,
    previewData: {
  ...
  },
  {
    ...
    content:
      "From my design process notes to a complete UX course in minutes. The generated content maintained all my methodologies perfectly.",
    rating: 5,
    previewData: {
