...
export const blogSchema = z.object({
  ...
  content: z
    .string()
    .describe("The complete blog post content in markdown format"),
...
export const listicleSchema = z.object({
  title: z
    .string()
    .describe(
      'A catchy, numbered title for the listicle (e.g., "7 Essential Tips for...")'
    ),
  description: z
    .string()
    .describe("A compelling description highlighting the value of the list"),
  content: z
    .string()
    .describe(
      "The complete listicle content in markdown format with numbered sections"
    ),
  tags: z.array(z.string()).describe("Relevant tags for the content"),
  keyPoints: z.array(z.string()).describe("Key takeaways from the content"),
  estimatedReadTime: z.number().describe("Estimated reading time in minutes"),
...
export const courseSchema = z.object({
  ...
  description: z
    .string()
    .describe("A compelling description of what learners will achieve"),
  lessons: z
    .array(
      z.object({
        ...
        quiz: z
          .object({
            question: z
              .string()
              .describe("Clear, focused question about the lesson"),
            options: z
              .array(z.string())
              .length(4)
  ...
  estimatedReadTime: z
    .number()
    .describe("Total course completion time in minutes"),
  price: z.number().describe("Suggested price for this content in USD"),
});
